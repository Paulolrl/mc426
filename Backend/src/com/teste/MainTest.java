...
public class MainTest extends JerseyTest {
    ...
    @Test
    public void test3CriarEquipeErro() {
    	JSONObject jsonRequest = new JSONObject("{\r\n" + 
    			"	\"nome\": \"Minha Equipe\",\r\n" + 
    ...
    public void test5VisulizaEquipe() {
    	ClientResponse response = resource().path("equipes/2").header("Authorization", "Basic cGF1bG86MTIzNDU2").get(ClientResponse.class);
    	JSONObject jsonExpected = new JSONObject("{\r\n" + 
    			"    \"dono\": \"/usuarios/paulo\",\r\n" + 
    			"    \"membros\": [\r\n" + 
    			"    	 \"/usuarios/paulo\",\r\n" + 
